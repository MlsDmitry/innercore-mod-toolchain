...
class MakeConfig(BaseConfig):
    ...
    def get_adb(self):
        if sys.platform == 'win32':
            ...
            return self.get_path("toolchain/adb/platform-tools_osx/adb")
        elif sys.platform == 'linux':
            return self.get_path("toolchain/adb/platform-tools_linux/adb")
        else:
            print("[-]", 'Not supported os. Supported -> win32(Windows) darwin(Mac Os) linux(Linux')
